...
{
    public partial class UserControlMealSearch : UserControl
    {
        DataRow meal;
        public UserControlMealSearch(DataRow data)
        {
            InitializeComponent();
            meal = data;
        }

        private void UserControlMealSearch_Load(object sender, EventArgs e)
        {
